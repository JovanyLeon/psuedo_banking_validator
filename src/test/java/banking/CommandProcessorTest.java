...
public class CommandProcessorTest {
	...
	public void testProcessValidCreateCheckingCommand() {
		...
		assertNotNull(account, "banking.Bank should contain the created checking account.");
		assertEquals(1.0, account.getApr(), "banking.Account APR should match.");
	}
	...
	public void testProcessValidCreateSavingsCommand() {
		...
		assertNotNull(account, "banking.Bank should contain the created savings account.");
		assertEquals(2.5, account.getApr(), "banking.Account APR should match.");
	}
	...
	public void testProcessValidCreateCDCommand() {
		...
		assertNotNull(account, "banking.Bank should contain the created CD account.");
		assertEquals(1.5, account.getApr(), "banking.Account APR should match.");
	...
	public void testProcessValidDepositCommand() {
		...
		Account account = bank.getAccount("12345678");
		assertNotNull(account, "banking.Account should exist.");
		assertEquals(200.0, account.getBalance(), "banking.Account balance should reflect the deposit.");
	}
	...
	public void testProcessMultipleDeposits() {
		...
		Account account = bank.getAccount("87654321");
		assertNotNull(account, "banking.Account should exist.");
		assertEquals(500.0, account.getBalance(), "banking.Account balance should reflect all deposits.");
	}
	...
	public void testProcessInvalidCommandIgnored() {
		...
		assertEquals(0, bank.getAccountsCount(), "banking.Bank should not create any accounts for invalid commands.");
	}
	...
	public void testProcessInvalidCreateCommandIgnored() {
		...
		assertNull(bank.getAccount("12345678"),
				"banking.Bank should not create an account for invalid create command.");
	}
	...
	public void testProcessInvalidDepositCommandIgnored() {
		...
		assertEquals(0, bank.getAccountsCount(), "banking.Bank should not perform deposit for nonexistent accounts.");
	}
	...
	public void testProcessDepositWithNonNumericAmountIgnored() {
		...
		Account account = bank.getAccount("12345678");
		assertNotNull(account, "banking.Account should exist.");
		assertEquals(0.0, account.getBalance(), "banking.Account balance should not change for invalid deposit.");
	}
}
